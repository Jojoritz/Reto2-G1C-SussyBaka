...
public interface UserController {
    /**
     * A REST client method for reseting the password passwing the data in XML format
     ...
     */
     ...
     /**
     * A REST client method for reseting the password passwing the data in JSON format
     * @param requestEntity the entity we want to change the password
     * @throws ClientErrorException 
     */
    ...
    /**
     * A RESTful client get method for obtain a user with the id passwing the data in XML format
     * @param <T> The type of the response type
     * @param responseType the type of the response that we expect to obtain after executing this method
    ...
    /**
     * A RESTful client get method for obtain a user with the id passwing the data in JSON format
     * @param <T> The type of the response type
     * @param responseType the type of the response that we expect to obtain after executing this method
     * @param id the id of the user we want to obtain
     * @return the user with the id we want
